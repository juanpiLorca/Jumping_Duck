...
HD_PWD='C:/Users/juanp/OneDrive/Desktop/SEP/ProjectSEPFinal/Hardware_Booster_Project/Hardware_Proyecto_Booster.runs/DEMO_Music_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_Music_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_Music_0_0.tcl
