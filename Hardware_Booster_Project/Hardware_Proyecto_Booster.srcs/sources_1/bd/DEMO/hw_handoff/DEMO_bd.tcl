...
proc create_root_design { parentCell } {
  ...
  set LightInt [ create_bd_port -dir I -from 0 -to 0 LightInt ]
  ...
  # Create instance: AXI_SPWM_driver_0, and set properties
  set AXI_SPWM_driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_SPWM_driver:1.0 AXI_SPWM_driver_0 ]
  ...
  set block_name Music
  set block_cell_name Music_0
  if { [catch {set Music_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Music_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins AXI_SPWM_driver_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]

  # Create port connections
  connect_bd_net -net AXI_SPWM_driver_0_enableMusic [get_bd_pins AXI_SPWM_driver_0/enableMusic] [get_bd_pins BUZZER_0/ENABLE_MUSIC] [get_bd_pins ila_0/probe2] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net AXI_SPWM_driver_0_leds [get_bd_ports LEDS] [get_bd_pins AXI_SPWM_driver_0/leds]
  connect_bd_net -net AXI_SPWM_driver_0_pwm_rgb [get_bd_ports PWM_RGB] [get_bd_pins AXI_SPWM_driver_0/pwm_rgb] [get_bd_pins ila_0/probe0]
  connect_bd_net -net BUZZER_0_BUZZER_PWM [get_bd_ports BUZZER_PWM] [get_bd_pins BUZZER_0/BUZZER_PWM] [get_bd_pins ila_0/probe1]
  connect_bd_net -net In2_0_1 [get_bd_ports LightInt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net Music_0_freq [get_bd_pins BUZZER_0/FREQUENCY] [get_bd_pins Music_0/freq]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins BUZZER_0/clk] [get_bd_pins Music_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_SPWM_driver_0/clk] [get_bd_pins AXI_SPWM_driver_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_quad_spi_1/ext_spi_clk] [get_bd_pins axi_quad_spi_1/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins Music_0/rst]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AXI_SPWM_driver_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_1/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_SPWM_driver_0/S00_AXI/S00_AXI_reg] -force
