...
-- Define a 1 [Hz] Sinusoid: 
signal freq : std_logic_vector(freq_width - 1 downto 0) := std_logic_vector(to_unsigned(1, freq_width)); 
...
pwm_out <= pwm_signal when (enable = '1') else '0'; 
